    ...
    swaggerDoc: {
      ...
      paths: {
        ...
        '/sa/quiz/questions': {
          get: {
            operationId:
              'QuizGameControllerSuperAdmin_getUnfinishedCurrentGame',
            parameters: [],
            responses: {
              200: {
                description: '',
        ...
        '/sa/quiz/questions/{id}': {
          ...
          put: {
            operationId:
              'QuizGameControllerSuperAdmin_ChangeBodyQuestionAndAnswer',
            parameters: [
              {
                name: 'id',
                required: true,
        ...
        '/sa/quiz/questions/{id}/publish': {
          put: {
            operationId:
              'QuizGameControllerSuperAdmin_changePublishedStatusToQuestion',
            parameters: [
              {
                name: 'id',
                required: true,
